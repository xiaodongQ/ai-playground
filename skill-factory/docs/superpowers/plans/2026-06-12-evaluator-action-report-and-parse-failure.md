...
```bash
cd /Users/xd/Documents/workspace/repo/ai-playground/skill-factory
go build -o /tmp/skill-factory-test ./cmd/server
```
...
```bash
go build -o /tmp/skill-factory-test ./cmd/server && echo OK
```
...
```bash
go build -o /tmp/skill-factory-test ./cmd/server
DB_PATH=./data/skill-factory.db ADDR=:8081 /tmp/skill-factory-test &
SERVER_PID=$!
sleep 2
